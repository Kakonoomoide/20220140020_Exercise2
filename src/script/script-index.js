...
const songs = [
  {
    path: "./assets/audio/iwantyou.mp3",
    displayName: "I Want You",
    cover: "./assets/img/cover-mirai.png",
    artist: "Saint House",
  },
  {
    path: "./assets/audio/InikahYangKauMau.mp3",
    displayName: "Ini kah Yang Kau Mau",
    cover: "./assets/img/cover-bird.png",
    artist: "Saint House",
  },
];
